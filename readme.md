...
4. 点击下方的`开始试用`（试用时间为30天），或前往[爱发电主页](https://www.ifdian.net/item/f73c144031b211f18e465254001e7c00)购买激活码。之前有打赏且打赏金额大于1CNY的，可将支付记录发送至uijm2004@outlook.com领取永久激活码。（注：由于爱发电账号认证问题，目前发送的激活码无法正常显示，请先使用试用模式）
